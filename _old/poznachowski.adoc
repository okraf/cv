...
ted refactoring process to encapsulate third party service (data provider) usage among several services for a potential technology switch (JEE 7, Wildfly 10).
